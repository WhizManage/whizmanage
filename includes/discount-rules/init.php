...
require_once WHIZMANAGE_DIR . 'includes/discount-rules/class-discount-api.php';
/**
 * Plugin bootstrap (init.php)
 */
 ...
 */
function whiz_dr_maybe_load_shortcode()
{
...
add_action('init', 'whiz_dr_maybe_load_shortcode');
...
function whiz_dr_maybe_install()
{
...
add_action('plugins_loaded', 'whiz_dr_maybe_install');

if (function_exists('register_activation_hook')) {
    register_activation_hook(__FILE__, 'whiz_dr_maybe_install');
}
...
// קבלת הבחירה מהטופס (לחיצה על "עדכן עגלה"/"Apply coupon" וכד')
...
// הצגת לייבל טיר של Bulk בכל מקום (עגלת קניות, צ'קאאוט, מיני־קארט)
