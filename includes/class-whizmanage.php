...
if (! class_exists('Whizmanage')) {
    ...
    class Whizmanage
    {
         ...
         * This ensures wp_set_script_translations "catches" correctly.
         *
        ...
        public function enqueue_admin_assets($hook_suffix)
        {
            ...
            $asset      = file_exists($asset_path)
                ...
                : array(
                    ...
                    'version'      => (defined('WHIZMANAGE_PRO_VERSION') ? WHIZMANAGE_PRO_VERSION : time()),
                );
            ...
            // Standard WP way: loads whizmanage-he_IL-*.json (generated by wp i18n make-json)
            ...
            if (get_user_locale() === 'he_IL') {
                ...
                if (file_exists($manual_json)) {
                    ...
                    if (!empty($jed['locale_data']['whizmanage'])) {
                        wp_add_inline_script(
                            'whizmanage-script',
                            'try{wp.i18n.setLocaleData(' .
                                wp_json_encode($jed['locale_data']['whizmanage']) .
                                ', "whizmanage");}catch(e){}',
                            'before'
                        );
                    }
