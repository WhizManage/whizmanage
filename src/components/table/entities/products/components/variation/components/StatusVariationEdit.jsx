// src/components/table/products/components/variation/components/StatusVariationEdit.jsx

import { PRODUCT_STATUS_KEYS } from "../products.constants"
...
const StatusVariationEdit = ({ row, updateValue }) => {
  ...
  return (
    <div className=" !rounded-md overflow-hidden !border-0 p-0 !border-slate-50">
      ...
      >
        {Object.keys(PRODUCT_STATUS_KEYS)
          .slice(0, -1)
          .map((statusItem) => (
            <option
              value={statusItem}
              className={cn(
                ...
                PRODUCT_STATUS_KEYS[statusItem]
              )}
            >
