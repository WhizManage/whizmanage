...
const DropdownMenuSubContent = React.forwardRef(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover dark:bg-slate-800 dark:border-slate-600 p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      className
    )}
    {...props} />
))
  ...
  ({ className, sideOffset = 4, ...props }, ref) => (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        // אפשרי: להגדיר ברירת מחדל נחמדה
        align="start"
        collisionPadding={8}
        className={cn(
          "z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover dark:bg-slate-800 dark:border-slate-600 p-1 text-popover-foreground shadow-md",
          // כדי שלא יברח מגובה המסך, גם אם יש מלא שדות
          "max-h-[calc(100vh-120px)] overflow-y-auto",
          // האנימציות שכבר היו לך:
