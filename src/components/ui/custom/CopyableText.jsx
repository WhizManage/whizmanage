// src/components/ui/custom/CopyableText.jsx
...
const CopyableText = ({
  ...
  const variantClasses = {
    default:
      "group relative cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors duration-200 rounded-md p-2 -m-2 flex items-center gap-2",
    minimal:
      "group relative cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors duration-200 rounded p-1 -m-1 flex items-center gap-1",
    button:
      "group relative cursor-pointer bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors duration-200 rounded-lg px-3 py-2 flex items-center gap-2 border border-slate-200 dark:border-slate-600",
    inline:
      "group relative cursor-pointer flex items-center gap-1 transition-opacity duration-200",
  };
  ...
  return (
    ...
    >
      <span className="flex-1 select-none">{displayText}</span>
