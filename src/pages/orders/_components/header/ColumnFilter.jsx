...
export const columnFilterFn = (row, columnId, filterValue) => {
  ...
  if (columnId === "paid") {
    rowValue = typeof rowValue === "string" ? "paid" : "unpaid";
  }
...
const ColumnFilter = ({
  ...
  const getAllUniqueValues = (data, columnName, keyPath) => {
    ...
    data.forEach((row) => {
      ...
      if (columnName === "paid") {
        uniqueValues.add(typeof item === "string" ? "paid" : "unpaid")
  ...
  const getValueCounts = (data, columnName, keyPath) => {
    return data.reduce((acc, row) => {
      ...
      if (columnName === "paid") {
        const value = typeof item === "string" ? "paid" : "unpaid";
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          ...
          >
            ...
            {__(formatText(label), "whizmanage")}
          </Button>
        </DropdownMenuTrigger>
        <DropdownMenuContent
          align="end"
