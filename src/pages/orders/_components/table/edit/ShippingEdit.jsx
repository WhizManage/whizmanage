...
/**
 * ShippingEdit (aligned with BillingEdit)
 * - RTL/LTR based on i18n.language (he => RTL)
 * - Inputs are controlled + padded so the floating export button doesn't overlap
 * - Email/Phone forced LTR for caret/typing direction
 */
const ShippingEdit = ({ row, table, isEditing = false }) => {
  ...
  useEffect(() => {
    if (row && row.original) {
      row.original.shipping = shippingData;
    }
  }, [shippingData, row]);
  ...
  const handleInputChange = (field, value) => {
    ...
    if (row) row.original.shipping = newShippingData;
  };
  ...
  return (
    <>
      <CustomTooltip title={isEditing ? __("Edit Shipping Information", "whizmanage") : __("View Shipping Information", "whizmanage")}>
        <Button
            ...
            <>
              <ModalHeader className="flex gap-2 text-center text-2xl justify-center items-center">
                <h2 className="text-center dark:text-gray-400">
                  {isEditing ? __("Edit Shipping Information", "whizmanage") : __("Shipping Information", "whizmanage")}
                </h2>
              </ModalHeader>
              <ModalBody className="!scrollbar-hide">
                <div className="flex flex-col gap-4 p-4 text-muted-foreground">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="relative w-full">
                        <Input
                          ...
                          disabled={!isEditing}
                        />
                        <ExportButton fieldKey="shipping_name" additionalFields={["shipping_name"]} label="Name" />
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <Label htmlFor="shipping-state">{__("State", "whizmanage")}</Label>
                      <div className="relative w-full">
                        <Input
                          id="shipping-state"
                          type="text"
                          ...
                          disabled={!isEditing}
                        />
                        <ExportButton fieldKey="shipping_state" label="State" />
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                  ...
                  {/* Contact Information */}
                  <div className="flex flex-col gap-2">
                    <Label htmlFor="shipping-email">{__("Email", "whizmanage")}</Label>
                    <div className="relative w-full">
                      <Input
                        id="shipping-email"
                        type="email"
                        ...
                        disabled={!isEditing}
                      />
                      <ExportButton fieldKey="shipping_email" label="Email" />
                    </div>
                  </div>
